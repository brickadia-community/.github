...
* [omegga](https://github.com/brickadia-community/omegga), the number-one choice for server management, plugins, and automation
* [brixide](https://github.com/brickadia-community/brixide), an experimental server wrapper for the Brickadia Alpha written in Rust

#### Tools

> **Note**: Brickadia EA3 removed support for the BRS format. Use the `archive-ea2` branch or the [brs2brz](https://brs2brz.kmschr.com/) tool to upgrade BRS files to BRZ

* [BrickCartographer](https://github.com/brickadia-community/BrickCartographer), a site to view BRS, BRDB, and BRZ maps
* [heightmap2brz](https://github.com/brickadia-community/heightmap2brz) (works as img2brz, img2text), a generator that constructs saves from heightmaps/colormaps
...
* [brdb](https://github.com/brickadia-community/brdb), a BRDB/BRZ read/writer for Rust
* [brs-js](https://github.com/brickadia-community/brs-js), a BRS/BRDB/BRZ save reader/writer for JavaScript and Typescript
